...
// screen -- newlib's float formatter needs several hundred bytes on top of the ~450 the render
// path already used, and the overflow hook disables interrupts and spins, so the board looked
// dead the moment the brake button was pressed.
//
